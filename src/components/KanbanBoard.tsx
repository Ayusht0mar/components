...
const DEFAULT_CARDS: CardType[] = [
  ...
  { title: "Postmortem for outage", id: "6", column: "sunday" },
  { title: "Sync with product on Q3 roadmap", id: "7", column: "sunday" },
  ...
  { title: "Add logging to daily CRON", id: "9", column: "monday" },
  // DONE
  {
